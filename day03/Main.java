...
public class Main {
    ...
    private static int part2(ArrayList<String> data, int sum2) {
        for (int i = 0; i < data.size(); i += 3) {
            ...
            sum2 = getSum(elfA, elfB, elfC, sum2);
        }

        return sum2;
    }

    private static int getSum(String elfA, String elfB, String elfC, int sum2) {
    ...
    private static int part1(int sum, String s1, String s2) {
